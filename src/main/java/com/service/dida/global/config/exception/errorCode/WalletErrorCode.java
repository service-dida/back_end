...
public enum WalletErrorCode implements ErrorCode {
    ...
    FIVE_ERRORS_FOR_PWD("WALLET_006", "비밀번호를 5번 이상 잘못 입력하였습니다.", HttpStatus.FORBIDDEN),
    ...
    FAILED_GET_DIDA("WALLET_010", "DIDA 확인에 실패하였습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
